	...
	$custom_settings = array(
		...
		'settings'        => array(
			...
			array(
				'id'           => 'logo_upload',
				'label'        => 'Логотип',
				'desc'         => 'Выберите изображение логотипа сайта',
				'type'         => 'upload',
				'section'      => 'header',
			),

			array(
				'id'           => 'main_banner_upload',
				'label'        => 'Баннер страницы',
				'desc'         => 'Выберите изображение баннера сайта (Рекомендуемый размер изображения: ?x? px, форматы: PNG, JPG)',
				'type'         => 'upload',
				'section'      => 'header',
			),

			array(
				'id'           => 'site_descr_toggle',
				'label'        => 'Отобразить описание сайта',
				'desc'         => 'Выберите, показывать или скрыть описание сайта',
				'std'          => 'on',
				'type'         => 'on-off',
				'section'      => 'header',
			),
			...
			array(
				'id'           => 'logo_upload_alter',
				'label'        => 'Логотип (альтернативный)',
				'desc'         => 'Выберите изображение логотипа сайта для темного фона',
				'type'         => 'upload',
				'section'      => 'footer',
			),
			array(
